...
/****************************************************************/
#ifndef INTERACTIONINTEGRALVPP_H
#define INTERACTIONINTEGRALVPP_H

#include "ElementVectorPostprocessor.h"
#include "CrackFrontDefinition.h"

// Forward Declarations
class InteractionIntegralVPP;
class RankTwoTensor;

template <>
InputParameters validParams<InteractionIntegralVPP>();

/**
 * This vectorpostprocessor computes the Interaction Integral
 *
 */
class InteractionIntegralVPP : public ElementVectorPostprocessor
{
public:
  InteractionIntegralVPP(const InputParameters & parameters);
...
#endif // INTERACTIONINTEGRALVPP_H
